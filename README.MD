...
*Update*: Decided to put all of my C# completed katas here too, even if they are
lower than kyu5, as well as the equivalent solution for Python if codewars has a
translation.
...
### Prime Factorization
* Descripton of Kata: The prime factorization of a positive integer is a list of
...
### Valid Parentheses
* Descripton of Kata: Write a function called validParentheses that takes
...
### Simple Fun #81: Digits Product
* Descripton of Kata: Given an integer product, find the smallest positive integer
...
### Car Park Escape
* Descripton of Kata: Your task is to escape from the carpark using only the
...
### Did I Finish my Sudoku?
* Descripton of Kata: Write a function done_or_not passing a board (list[list_lines])
...
### Find the unique string
* Descripton of Kata: There is an array of strings. All strings contains similar
...
* Descripton of Kata: You are given a string containing 0's, 1's and one or more
'?', where ? is a wildcard that can be 0 or 1. Return an array containing all the
possibilities you can reach substituting the ? for a value.
* Difficulty: kyu5
* Module: possibilities.py
* Tests: test_possibilities.py
* Link: https://www.codewars.com/kata/1-s-0-s-and-wildcards/python
* Comments about most interesting solution/best practice: Top voted and recursive
solutions shouldn't have passed actually as they are both slow. the codegolf solution
is only slightly slower than my submitted solution.
Highest voted:
```python
...
### One Line Task: Palindrome String
* Descripton of Kata: Your task is to generate a palindrome string, using the
...
### Strip Url Params
* Descripton of Kata: Write a method that
